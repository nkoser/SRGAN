...
if __name__ == "__main__":
    ...
    # Target folder
    target_train_folder = r'/views/data-acc/RW/sukin707/superresolution/data/UKE_pt_train/low_res'
    target_train_hr_folder = r'/views/data-acc/RW/sukin707/superresolution/data/UKE_pt_train/high_res'
    target_val_folder = r'/views/data-acc/RW/sukin707/superresolution/data/UKE_pt_val/low_res'
    target_val_hr_folder = r'/views/data-acc/RW/sukin707/superresolution/data/UKE_pt_val/high_res'
